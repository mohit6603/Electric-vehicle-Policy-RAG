...
Expected output: **eight passed notebook checks**. The [Stage 6 handoff](STAGE_6_HANDOFF.md) documents aliases, conflict handling, source-version rules and the 19 repeatable retrieval checks. Context remains unverified evidence; Stage 7 consumes these exact excerpts for answer generation.
